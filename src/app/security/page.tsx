  ...
  return (
    <div className=''>
      ...
      <div className='bg-white sm:h-[70vh]   w-full py-10'>
        ...
        <div className=' container sm:flex sm:flex-wrap xl:flex xl:flex-wrap-none justify-around  justify-items-center items-center mt-5'>
          ...
          <div className="relative sm:h-[30vh] h-[40vh] w-full"
            style={{
              backgroundImage:
      ...
      <div className='  border  w-full  bg-white text-black '>
        <div className='container  text-center '>
          <p className='font-bold  text-xl sm:text-2xl py-4'>Differentiators of Advanced Cybersecurity</p>
          <div className='container mt-3 sm:flex sm:flex-wrap  justify-around '>

            <div className=' h-[40vh]  sm:mb-2 sm:w-[30vw]  bg-gray-200 rounded-lg cursor-pointer'>
            ...
            <div className=' h-[40vh]  sm:w-[30vw]  bg-gray-200 rounded-lg cursor-pointer'>
              <div className="   h-[10vh] w-24 ml-3 mt-3"
                style={{
                  backgroundImage:
