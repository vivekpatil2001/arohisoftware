            ...
            >
              ...
              >
                ...
                <div className="flex flex-col space-y-4 py-7">
                  ...
                  <HoveredLink href="/service" className="">
          ...
          <div className="lg:hidden">
            <Menu setActive={setActive} className="block">
              <MenuItem
                ...
                item="What we do >"
              >
                <div className="flex flex-col space-y-4 py-7 text-xl">
                  <p className="mb-2 text-xl text-slate-400 hover:text-yellow-400 hover:cursor-text ">
                    What we do<span>➡️</span>
                  </p>
                  <HoveredLink href="/service" className="">
              ...
              <MenuItem setActive={setActive} active={active} item="Careers >">
                <div className="flex flex-col space-y-4 text-xl mb-2 text-slate-400 hover:text-yellow-400 hover:cursor-text ">
                  <p className="mb-2">
                    Careers home <span>➡️</span>
                  </p>
                  <HoveredLink href="/courses" className="">
